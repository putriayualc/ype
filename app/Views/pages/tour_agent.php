            ...
            <div data-elementor-type="wp-page" data-elementor-id="28" class="elementor elementor-28">
                ...
                <div class="container1 reverse">
                    <div class="text-section">
                        <h2 style="color: #333; font-family: Open Sans, Arial, sans-serif; line-height: 1.7em; font-weight: 700; font-size: 24px;">
                            <?= $language == 'en' ? 'Partnership with Travel Agents' : 'Kemitraan dengan Travel Agent'; ?>
                        </h2>
                        <p>
                            <?= $language == 'en' ? 'Are you a <strong>travel agent</strong> seeking a trusted <strong>tour operator in Europe?</strong> Look no further than Your Private Europe (YPE). With our expertise in managing destinations across Europe and a deep understanding of the needs of travelers from <strong>Indonesia and Asia</strong>, we are your ideal partner.' : 'Apakah Anda travel agent yang mencari partner <strong>tour operator</strong> terpercaya di Eropa? <strong>Your Private Europe (YPE)</strong> adalah solusi yang Anda butuhkan. Kami bukan hanya ahli dalam manajemen destinasi wisata di seluruh Eropa, tapi kami juga memahami secara mendalam kebutuhan wisatawan Indonesia dan Asia.'; ?>
                        </p>

                        <p>
                            <?= $language == 'en' ? 'As a professional <strong>B2B travel partner</strong>, we offer <strong>custom-made private and group tours</strong> tailored entirely to your clients’ needs and expectations. Whether it’s <strong>exclusive vacations, family holidays,</strong> or <strong>business group tours</strong>, we provide the perfect solution from planning to execution.' : 'Sebagai mitra <strong>B2B yang profesional</strong>, kami menawarkan layanan <strong>custom-made private</strong> dan <strong>group tours</strong> yang sepenuhnya disesuaikan dengan kebutuhan dan ekspektasi klien Anda. Apakah klien Anda mencari perjalanan eksklusif, liburan keluarga, atau grup tur bisnis, kami siap memberikan solusi yang tepat, dari perencanaan hingga eksekusi.'; ?>
                        </p>

                        <p>
                            <?= $language == 'en' ? 'From crafting <strong>itineraries</strong>, arranging <strong>accommodations and transportation</strong>, to managing special requests like <strong>VIP tours</strong> or <strong>bespoke events</strong>, YPE ensures every detail is handled with precision. Partner with us to deliver <strong>unforgettable travel experiences</strong> for your clients.' : 'Dari penyusunan itinerary, akomodasi, transportasi, hingga kebutuhan khusus seperti tur <strong>VIP</strong> atau acara spesial, YPE siap membantu. Jadikan kami partner Anda dalam menciptakan pengalaman <strong>wisata yang tak terlupakan</strong> bagi klien Anda.'; ?>
                        </p>

                    </div>
                    <div class="image-section">
                        <img src="<?= base_url('assets/images/tour_agent/tour_agent_1.jpg') ?>" alt="Event Management">
                    </div>
                </div>
                ...
                <div class="container1">
                    <div class="text-section" style="margin-left: 20px;">
                        <h2 style="color: #333; font-family: Open Sans, Arial, sans-serif; line-height: 1.7em; font-weight: 700; font-size: 24px;">
                            <?= $language == 'en' ? 'Solutions for Corporate Group Tours & Travel Agent Partnerships' : 'Solusi untuk Corporate Group Tour & Mitra Travel Agent:'; ?>
                        </h2>
                        <ul class="plan-list1" style="font-family: 'Open Sans' !important;font-weight: 500;font-size: 16px; line-height: 24px;padding:15px !important;">
                            <li><?= $language == 'en' ? 'Custom itineraries and programs' : 'Itinerary & program'; ?></li>
                            <li><?= $language == 'en' ? 'Flights and visa assistance' : 'Tiket pesawat & visa'; ?></li>
                            <li><?= $language == 'en' ? 'Accommodation arrangements' : 'Akomodasi'; ?></li>
                            <li><?= $language == 'en' ? 'Venue selection' : 'Venue'; ?></li>
                            <li><?= $language == 'en' ? 'Transportation services' : 'Layanan Transportasi'; ?></li>
                            <li><?= $language == 'en' ? 'Staffing solutions' : 'Staffing'; ?></li>
                            <li><?= $language == 'en' ? 'Food & Beverage coordination' : 'Food & Beverage'; ?></li>
                            <li><?= $language == 'en' ? 'All other logistical needs' : 'Hal-hal logistik lainnya'; ?> </li>
                        </ul>
                        <p>
                            <?= $language == 'en' ? 'As your trusted partner in <strong>Europe tour and travel</strong>, Your Private Europe (YPE) is here to simplify the complexities of <strong>group and corporate travel</strong>, allowing you to focus on delivering exceptional experiences for your clients.' : 'Sebagai mitra terpercaya Anda dalam <strong>tour dan travel di Eropa</strong>, Your Private Europe (YPE) hadir untuk menyederhanakan kompleksitas <strong>perjalanan grup dan korporat</strong>, sehingga Anda dapat fokus memberikan pengalaman luar biasa bagi klien Anda.'; ?>
                        </p>
                    </div>
                    <div class="image-section">
                        <img src="<?= base_url('assets/images/tour_agent/tour_agent_2.jpg') ?>" alt="Solusi untuk Corporate Group Tour & Mitra Travel Agent">
                    </div>
                </div>
