    ...
    <div class="container-xl">
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                <form action="/admin/tour_description/update/<?= $description['id'] ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="destination_id" name="destination_id" required>
                                    ...
                                    <?php foreach ($destinations as $destination) : ?>
                                        <option value="<?= $destination['id'] ?>" 
                                            <?= ($destination['id'] == old('destination_id', $description['destination_id'])) ? 'selected' : '' ?>>
                                            <?= $destination['title'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title_id" name="title_id" 
                                    value="<?= old('title_id', $description['title_id']) ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sub_title_id" name="sub_title_id" 
                                    value="<?= old('sub_title_id', $description['sub_title_id']) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title_en" name="title_en" 
                                    value="<?= old('title_en', $description['title_en']) ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sub_title_en" name="sub_title_en" 
                                    value="<?= old('sub_title_en', $description['sub_title_en']) ?>">
                            </div>
                        </div>
                    </div>
