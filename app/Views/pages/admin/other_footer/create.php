...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <div class="row g-3 mb-4 align-items-center justify-content-between">
            ...
            <div class="col-auto">
                <a href="/admin/other-footer" class="btn btn-secondary">Back to List</a>
            </div>
        </div>
        ...
        <div class="app-card app-card-settings shadow-sm p-4">
            <div class="app-card-body">
                <form action="/admin/other_footer/store" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="mb-3">Indonesian Content</h4>
                            <div class="mb-3">
                                <label for="seo_tag_title_id" class="form-label">SEO Title</label>
                                <input type="text" class="form-control" id="seo_tag_title_id" name="seo_tag_title_id">
                            </div>
                            <div class="mb-3">
                                <label for="seo_description_id" class="form-label">SEO Description</label>
                                <textarea class="form-control" id="seo_description_id" name="seo_description_id" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="desc_id" name="desc_id" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="seo_tag_title_en" name="seo_tag_title_en">
                            </div>
                            <div class="mb-3">
                                <label for="seo_description_en" class="form-label">SEO Description</label>
                                <textarea class="form-control" id="seo_description_en" name="seo_description_en" rows="3"></textarea>
                            </div>
                            <div class="mb-3">
