    ...
    <article aria-label="article" id="post-28" class="post-28 page type-page status-publish hentry">
        <div class="inner-post">
            <div data-elementor-type="wp-page" data-elementor-id="28" class="elementor elementor-28">
                ...
                <!-- Mice Start -->
                <?php foreach ($destinationEvents as $index => $event): ?>
                        <div class="container1 <?= ($index % 2 == 0) ? 'reverse' : '' ?>"> <!-- Alternating order -->
                            <div class="text-section" style="margin-left: 20px;">
                                <h2 style="color: #333; font-family: Open Sans, Arial, sans-serif; line-height: 1.7em; font-weight: 700; font-size: 24px;">
                                    <?= $language == 'en' ? $event['title_en'] : $event['title_id'] ?>
                                </h2>
                                <p>
                                    <?= $language == 'en' ? $event['desc_en'] : $event['desc_id'] ?>
                                </p>
                            </div>
                            <div class="image-section">
                                <img src="<?= base_url('assets/images/destination_event/' . $event['image']) ?>" alt="<?= $language == 'en' ? $event['title_en'] : $event['title_id'] ?>">
                            </div>
                        </div>
                <?php endforeach; ?>
